...
public enum HerokuTestPagesEnum {
    ...
    DIGEST_AUTHENTICATION("Digest Authentication (user and pass: admin)"),
    ...
    JAVASCRIPT_ON_LOAD_EVENT_ERROR("JavaScript onload event error"),
    KEY_PRESSES("Key Presses"),
    LARGE_AND_DEEP_DOM("Large & Deep DOM"),
